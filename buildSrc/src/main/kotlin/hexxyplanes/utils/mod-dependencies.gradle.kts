...
abstract class HexxyplanesModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexxyplanesModDependenciesExtension>("hexxyplanesModDependencies")
